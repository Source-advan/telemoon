...
function show_supergroup_settingsmod(msg, target)
  ...
  local text = "⚙<b>SuperGroup settings</b>⚙:\n\n❗️#Lock Links > "..settings.lock_link.."\n❗️#Lock <b>Webpage ></b> <i>"..settings.lock_webpage.."</i>\n❗️#️Lock <b>Tag ></b> <i>"..settings.lock_tag.."</i>\n❗️#️Lock <b>Emoji ></b> <i>"..settings.lock_emoji.."</i>\n❗️#Lock<b> English ></b> <i>"..settings.lock_eng.."</i>\n❗️#Lock <b>Badword ></b> <i>"..settings.lock_badw.."</i>\n❗️#Lock <b>Flood ></b> <i>"..settings.flood.."</i>\n❗️#Flood <b>sensitivity ></b> <code>"..NUM_MSG_MAX.."</code>\n❗️#Lock <b>Spam ></b> "..settings.lock_spam.."</i>\n❗️#Lock <b>Contacts ></b> "..settings.lock_contacts.."</i>\n❗️#Lock <b>Arabic/Persian ></b> <i>"..settings.lock_arabic.."</i>\n❗️Lock <b>Member ></b> <i>"..settings.lock_member.."</i>\n❗️#Lock <b>RTL ></b> <i>"..settings.lock_rtl.."</i>\n❗️#Lock <b>Forward ></b> <i>"..settings.lock_fwd.."</i>\n❗️#Lock <b>TGservice ></b> <i>"..settings.lock_tgservice.."</i>\n❗️#Lock <b>Sticker ></b> <i>"..settings.lock_sticker.."</i>\n❗️#Public > <i>"..settings.public.."</i>\n❗️#Strict <b>Settings ><b> <i>"..settings.strict</i>
