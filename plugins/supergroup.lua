...
local function check_member_super(cb_extra, success, result)
  ...
  for k,v in pairs(result) do
    ...
    if member_id ~= our_id then
      ...
      save_data(_config.moderation.data, data)
	  local text = 'SuperGroup has been added by ['..msg.from.id..'](@'..msg.from.username..')'
...
local function run(msg, matches)
	...
	local data = load_data(_config.moderation.data)
		...
		if matches[1] == 'help' and not is_momod(msg) then
			text = "ظ„غŒط³طھ ط¯ط³طھظˆط±ط§طھ ط¨ط±ط§غŒ ط§ط¹ط¶ط§غŒ ظ…ط¹ظ…ظˆظ„غŒ:\n\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#topstats\nظ†ط´ط§ظ† ط¯ط§ط¯ظ† غ³ ظ†ظپط± ط§ط² ظپط¹ط§ظ„ طھط±غŒظ† ط§ط¹ط¶ط§غŒ ع¯ط±ظˆظ‡!\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#filterlist\nظ†ط´ط§ظ† ط¯ط§ط¯ظ† ع©ظ„ظ…ظ‡ ظ‡ط§غŒ ظپغŒظ„طھط± ط´ط¯ظ‡.\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#id\nظ†ظ…ط§غŒط´ ط§ط·ظ„ط§ط¹ط§طھ ط§ع©ط§ظ†طھ ط´ظ…ط§ .\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#sticker [reply]\nط¨ط§ ط±غŒظ¾ظ„ط§غŒ ع©ط±ط¯ظ† ط¹ع©ط³ ظ…غŒطھظˆط§ظ†غŒط¯ ط¢ظ† ط±ط§ ط¨ظ‡ ط§ط³طھغŒع©ط± طھط¨ط¯غŒظ„ ع©ظ†غŒط¯!\n#sticker [text]\nطھط¨ط¯غŒظ„ ظ…طھظ† ط´ظ…ط§ ط¨ظ‡ ط§ط³طھغŒع©ط± ...\n#sticker [text] [color]\nطھط¨ط¯غŒظ„ ظ…طھظ† ط´ظ…ط§ ط¨ظ‡ ط§ط³طھغŒع©ط± ط¨ط§ طھظ†ط¸غŒظ… ط±ظ†ع¯ ...\n#sticker [text] [color] [font]\n\nطھط¨ط¯غŒظ„ ظ…طھظ† ط´ظ…ط§ ط¨ظ‡ ط§ط³طھغŒع©ط± ط¨ط§ طھظ†ط¸غŒظ… ط±ظ†ع¯ ظˆ ظپظˆظ†طھ...\n( Supported fonts : [fun|italic|bold|arial] )\n( Supported colors : [black|red|blue|yellow|pink|orange|brown] )\nطھط¨ط¯غŒظ„ ظ…طھظ† ط´ظ…ط§ ط¨ظ‡ ط§ط³طھغŒع©ط± ...\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#photo [reply]\nط¨ط§ ط±غŒظ¾ظ„ط§غŒ ع©ط±ط¯ظ† ط§ط³طھغŒع©ط± ظ…غŒطھظˆط§ظ†غŒط¯ ط¢ظ† ط±ط§ ط¨ظ‡ ط¹ع©ط³ طھط¨ط¯غŒظ„ ع©ظ†غŒط¯!\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#vc [kalame](ط²ط¨ط§ظ† ظ‡ط§ : Farsi,En)\nطھط¨ط¯غŒظ„ ع©ظ„ظ…ظ‡ ط¨ظ‡ طµط¯ط§\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#weather [ط§ط³ظ… ط´ظ‡ط±]\nط¯ط±غŒط§ظپطھ ط§ط·ظ„ط§ط¹ط§طھ ط¢ط¨ ظˆ ظ‡ظˆط§غŒ غŒع© ظ…ظ†ط·ظ‚ظ‡\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#aparat [ع©ظ„ظ…ظ‡] \nط¬ط³طھظˆط¬ظˆ ط¯ط± ط¢ظ¾ط§ط±ط§طھ!\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#me\nظ†ظ…ط§غŒط´ طھط¹ط¯ط§ط¯ ظ¾غŒط§ظ… ظ‡ط§غŒ ط§ط±ط³ط§ظ„ ط´ط¯ظ‡ ط§ط² ط´ظ…ط§\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#qr [ع©ظ„ظ…ظ‡]\nطھط¨ط¯غŒظ„ ع©ظ„ظ…ظ‡طŒظ„غŒظ†ع©طŒ... ط´ظ…ط§ ط¨ظ‡ ط¨ط§ط±ع©ط¯\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#insta [id, Post Link]\nط¯ط±غŒط§ظپطھ ط§ط·ظ„ط§ط¹ط§طھ ط§غŒط¯غŒ ظˆ ... ط§ط² ط§غŒظ†ط³طھط§ع¯ط±ط§ظ…!\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#calc [2*2]\nظ…ط­ط§ط³ط¨ظ‡ ط¬ظ…ط¹ طھظپط±غŒظ‚ ط¶ط±ط¨ ظˆ...\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#porn [text]\nط¬ط³طھط¬ظˆ ط¯ط± 7 ط³ط§غŒطھ +18\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#time\nط¯ط±غŒط§ظپطھ ط²ظ…ط§ظ† ط¯ظ‚غŒظ‚!\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#support \nط¯ط±غŒط§ظپطھ ظ„غŒظ†ع© ع¯ط±ظˆظ‡ ظ¾ط´طھغŒط¨ط§ظ†غŒ!\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#version\nظ†ظ…ط§غŒط´ ظˆط±عکظ† ظˆ ط§ط¯ظ…غŒظ† ظ‡ط§غŒ ط±ط¨ط§طھ!\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#plist\nط¯ط±غŒط§ظپطھ ظ„غŒط³طھ ظ‚غŒظ…طھ ط¨ط±ط§غŒ ط®ط±غŒط¯ ع¯ط±ظˆظ‡...\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#write [text]\nط·ط±ط§ط­غŒ ع©ظ„ظ…ظ‡ ظ…ظˆط±ط¯ طھط¸ط± ط¨ط§ 17 ظپظˆظ†طھ!\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#feedback [text]\nط´ظ…ط§ ظ…غŒطھظˆط§ظ†غŒط¯ ط¨ط§ ط§غŒظ† ط¯ط³طھظˆط± ظ†ط¸ط±ط§طھ ظˆ ظ¾غŒط´ظ†ظ‡ط§ط¯ط§طھ ط®ظˆط¯ ط±ط§ ط¨ط±ط§غŒ ظ…ط§ ط§ط±ط³ط§ظ„ ع©ظ†غŒط¯...\nâ‍–â‍–â‍–â‍–â‍–â‍–\n| Channel : @Red_Ch |\n"
			reply_msg(msg.id, text, ok_cb, false)
		elseif matches[1] == 'help' and is_momod(msg) then
			text = "ط±ط§ظ‡ظ†ظ…ط§غŒ ط¨ط§طھ ط¶ط¯ ط§ط³ظ¾ظ… ط±ط¯ط¨ط§طھ\nط¯ط±طµظˆط±طھ ط§ط¨ظ‡ط§ظ… ظ…غŒطھظˆظ†غŒط¯ ط¨ط§ ط¯ط³طھظˆط± /support ظ„غŒظ†ع© ع¯ط±ظˆظ‡ ظ¾ط´طھغŒط¨ط§ظ†غŒ ط±ط§ ط¯ط±غŒط§ظپطھ ع©ظ†غŒط¯ ظˆ  ظ…ط´ع©ظ„طھظˆظ† ط±ظˆ ظ…ط·ط±ط­ ع©ظ†غŒط¯! \n\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#ban @username\nط§ط®ط±ط§ط¬ ع©ط±ط¯ظ† غŒع© ظپط±ط¯ ط§ط² ع¯ط±ظˆظ‡ ط¨ظ‡ طµظˆط±طھ ط¯ط§ط¦ظ…غŒ\n#unban @username\nط®ط§ط±ط¬ ع©ط±ط¯ظ† غŒع© ظپط±ط¯ ط§ط² ط­ط§ظ„طھ ط§ط®ط±ط§ط¬ ط¯ط§ط¦ظ…غŒ!\n#banlist\nظ„غŒط³طھ ط§ظپط±ط§ط¯ ط¨ظ† ط´ط¯ظ‡.\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#info\nظ†ظ…ط§غŒط´ ط§ط·ظ„ط§ط¹ط§طھ ط§طµظ„غŒ ع¯ط±ظˆظ‡\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#del [reply|number]\nظ¾ط§ع© ع©ط±ط¯ظ† طھط¹ط¯ط§ط¯ ظ¾غŒط§ظ… ظ‡ط§غŒ ظ…ظˆط±ط¯ ظ†ط¸ط± ط¨ط§ ط±غŒظ¾ظ„غŒ ظˆ طھط¹ط¯ط§ط¯!\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#topstats\nظ†ط´ط§ظ† ط¯ط§ط¯ظ† غ³ ظ†ظپط± ط§ط² ظپط¹ط§ظ„ طھط±غŒظ† ط§ط¹ط¶ط§غŒ ع¯ط±ظˆظ‡!\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#admins\nظ†ظ…ط§غŒط´ ظ„غŒط³طھ ط§ط¯ظ…غŒظ† ظ‡ط§غŒ ع¯ط±ظˆظ‡\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#filter [word]\nظپغŒظ„طھط± ع©ط±ط¯ظ† غŒع© ع©ظ„ظ…ظ‡\n#remword [word]\nط­ط°ظپ ع©ط±ط¯ظ† ع©ظ„ظ…ظ‡ ط§ط² ظ„غŒط³طھ ظپغŒظ„طھط± ع©ظ„ظ…ط§طھ\n#filterlist\nظ†ط´ط§ظ† ط¯ط§ط¯ظ† ع©ظ„ظ…ظ‡ ظ‡ط§غŒ ظپغŒظ„طھط± ط´ط¯ظ‡.\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#owner\nظ†ظ…ط§غŒط´ ط¢غŒط¯غŒ ط®ط±غŒط¯ط§ط± ع¯ط±ظˆظ‡.\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#modlist\nظ†ظ…ط§غŒط´ ظ„غŒط³طھ ظ†ط§ط¸ظ… ظ‡ط§.\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#bots\nظ„غŒط³طھ ط±ظˆط¨ط§طھ ظ‡ط§غŒ ع¯ط±ظˆظ‡.\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#who\nظ„غŒط³طھ ط§ط¹ط¶ط§غŒ ع¯ط±ظˆظ‡ ط¯ط± غŒع© ظپط§غŒظ„ ظ…طھظ†غŒ.\n(.txt)\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#kick [reply|id]\nط¨ظ„ط§ع© ع©ط±ط¯ظ† ظˆ ع©غŒع© ع©ط±ط¯ظ† ظپط±ط¯ ط§ط² ع¯ط±ظˆظ‡.\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#setwlc [your text]\nطھظ†ط¸غŒظ… غŒع© ظ…طھظ† ط¨ظ‡ ط¹ظ†ظˆط§ظ† ظ…طھظ† ط®ظˆط´ط§ظ…ط¯ ع¯ظˆغŒغŒ\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#setwlc rules [your text]\nطھظ†ط¸غŒظ… ع©ط±ط¯ظ† غŒع© ظ…طھظ† ط¨ظ‡ ط¹ظ†ظˆط§ظ† ظ¾ظ„ط§ظ… ط®ظˆط´ط§ظ…ط¯ ع¯ظˆغŒغŒ + ظ‚ظˆط§ظ†غŒظ† ع¯ط±ظˆظ‡.\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#delwlc\nط­ط°ظپ ظ¾غŒط§ظ… ط®ظˆط´ط§ظ…ط¯ ع¯ظˆغŒغŒ.\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#id\nظ†ظ…ط§غŒط´ ط§ط·ظ„ط§ط¹ط§طھ ط§ع©ط§ظ†طھ ط´ظ…ط§ .\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#sticker [reply]\nط¨ط§ ط±غŒظ¾ظ„ط§غŒ ع©ط±ط¯ظ† ط¹ع©ط³ ظ…غŒطھظˆط§ظ†غŒط¯ ط¢ظ† ط±ط§ ط¨ظ‡ ط§ط³طھغŒع©ط± طھط¨ط¯غŒظ„ ع©ظ†غŒط¯!\n#sticker [text]\nطھط¨ط¯غŒظ„ ظ…طھظ† ط´ظ…ط§ ط¨ظ‡ ط§ط³طھغŒع©ط± ...\n#sticker [text] [color]\nطھط¨ط¯غŒظ„ ظ…طھظ† ط´ظ…ط§ ط¨ظ‡ ط§ط³طھغŒع©ط± ط¨ط§ طھظ†ط¸غŒظ… ط±ظ†ع¯ ...\n#sticker [text] [color] [font]\n\nطھط¨ط¯غŒظ„ ظ…طھظ† ط´ظ…ط§ ط¨ظ‡ ط§ط³طھغŒع©ط± ط¨ط§ طھظ†ط¸غŒظ… ط±ظ†ع¯ ظˆ ظپظˆظ†طھ...\n( Supported fonts : [fun|italic|bold|arial] )\n( Supported colors : [black|red|blue|yellow|pink|orange|brown] )\nطھط¨ط¯غŒظ„ ظ…طھظ† ط´ظ…ط§ ط¨ظ‡ ط§ط³طھغŒع©ط± ...\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#photo [reply]\nط¨ط§ ط±غŒظ¾ظ„ط§غŒ ع©ط±ط¯ظ† ط§ط³طھغŒع©ط± ظ…غŒطھظˆط§ظ†غŒط¯ ط¢ظ† ط±ط§ ط¨ظ‡ ط¹ع©ط³ طھط¨ط¯غŒظ„ ع©ظ†غŒط¯!\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#vc [kalame](ط²ط¨ط§ظ† ظ‡ط§ : Farsi,En)\nطھط¨ط¯غŒظ„ ع©ظ„ظ…ظ‡ ط¨ظ‡ طµط¯ط§\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#weather [ط§ط³ظ… ط´ظ‡ط±]\nط¯ط±غŒط§ظپطھ ط§ط·ظ„ط§ط¹ط§طھ ط¢ط¨ ظˆ ظ‡ظˆط§غŒ غŒع© ظ…ظ†ط·ظ‚ظ‡\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#aparat [ع©ظ„ظ…ظ‡] \nط¬ط³طھظˆط¬ظˆ ط¯ط± ط¢ظ¾ط§ط±ط§طھ!\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#me\nظ†ظ…ط§غŒط´ طھط¹ط¯ط§ط¯ ظ¾غŒط§ظ… ظ‡ط§غŒ ط§ط±ط³ط§ظ„ ط´ط¯ظ‡ ط§ط² ط´ظ…ط§\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#qr [ع©ظ„ظ…ظ‡]\nطھط¨ط¯غŒظ„ ع©ظ„ظ…ظ‡طŒظ„غŒظ†ع©طŒ... ط´ظ…ط§ ط¨ظ‡ ط¨ط§ط±ع©ط¯\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#insta [id, Post Link]\nط¯ط±غŒط§ظپطھ ط§ط·ظ„ط§ط¹ط§طھ ط§غŒط¯غŒ ظˆ ... ط§ط² ط§غŒظ†ط³طھط§ع¯ط±ط§ظ…!\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#write [text]\nط·ط±ط§ط­غŒ ع©ظ„ظ…ظ‡ ظ…ظˆط±ط¯ طھط¸ط± ط¨ط§ 17 ظپظˆظ†طھ!\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#calc [2*2]\nظ…ط­ط§ط³ط¨ظ‡ ط¬ظ…ط¹ طھظپط±غŒظ‚ ط¶ط±ط¨ ظˆ...\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#porn [text]\nط¬ط³طھط¬ظˆ ط¯ط± 7 ط³ط§غŒطھ +\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#time\nط¯ط±غŒط§ظپطھ ط²ظ…ط§ظ† ط¯ظ‚غŒظ‚!\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#support \nط¯ط±غŒط§ظپطھ ظ„غŒظ†ع© ع¯ط±ظˆظ‡ ظ¾ط´طھغŒط¨ط§ظ†غŒ!\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#setowner [reply, username]\nط³طھ ع©ط±ط¯ظ† ع©ط§ط±ط¨ط± ط¨ظ‡ ط¹ظ†ظˆط§ظ† ط®ط±غŒط¯ط§ط± ع¯ط±ظˆظ‡\n#promote [username|id]\nط§ط±طھظ‚ط§ط، ظ…ظ‚ط§ظ… ع©ط§ط±ط¨ط± ط¨ظ‡ ظ†ط§ط¸ظ… ع¯ط±ظˆظ‡\n#demote [username|id]\nط®ظ„ط¹ ظ…ظ‚ط§ظ… ع©ط±ط¯ظ† ع©ط§ط±ط¨ط± ط§ط² ط³ظ…طھ ظ†ط§ط¸ظ… ظ‡ط§\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#setname [text]\nطھط؛غŒغŒط± ط§ط³ظ… ع¯ط±ظˆظ‡\n#setphoto\nط¬ط§غŒع¯ط²غŒظ† ع©ط±ط¯ظ† ط¹ع©ط³ ع¯ط±ظˆظ‡\n#setrules [text]\nع¯ط°ط§ط´طھظ† ظ‚ظˆط§ظ†غŒظ† ط¨ط±ط§غŒ ع¯ط±ظˆظ‡\n#setabout [text]\nع¯ط°ط§ط´طھظ† ظ…طھظ† طھظˆط¶غŒط­ط§طھ ط¨ط±ط§غŒ ط³ظˆظ¾ط± ع¯ط±ظˆظ‡(ط§غŒظ† ظ…طھظ† ط¯ط± ط¨ط®ط´ طھظˆط¶غŒط­ط§طھ ع¯ط±ظˆظ‡ ظ‡ظ… ظ†ظ…ط§غŒط´ ط¯ط§ط¯ظ‡ ظ…غŒط´ظ‡)\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#newlink\nط³ط§ط®طھظ† ظ„غŒظ†ع© ط¬ط¯غŒط¯\n#link\nع¯ط±ظپطھظ† ظ„غŒظ†ع©\n#linkpv\nط§ط±ط³ط§ظ„ ظ„غŒظ†ع© ع¯ط±ظˆظ‡ ط¯ط± ظ¾غŒظˆغŒ ط´ظ…ط§!\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#rules\nظ†ظ…ط§غŒط´ ظ‚ظˆط§ظ†غŒظ†\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#lock [links|flood|spam|Arabic|member|rtl|sticker|TgService|contacts|forward|badword|emoji|english|tag|webpage|strict]\nظ‚ظپظ„ ع©ط±ط¯ظ† ظ„غŒظ†ع© ع¯ط±ظˆظ‡ط§-ط§ط³ظ¾ظ…-ظ…طھظ† ظˆ ط§ط³ظ… ظ‡ط§غŒ ط¨ط²ط±ع¯ -ط²ط¨ط§ظ† ظپط§ط±ط³غŒ-طھط¹ط¯ط§ط¯ ط§ط¹ط¶ط§-ع©ط§ط±ط§ع©طھط± ظ‡ط§غŒ ط؛غŒط± ط¹ط§ط¯غŒ-ط§ط³طھغŒع©ط±-ظ…ط®ط§ط·ط¨غŒظ†-ظپط±ظˆط§ط±ط¯-ظپظˆط´-ط§ظ…ظˆط¬غŒ-ط§ظ†ع¯ظ„غŒط³غŒ-طھع¯-ظ„غŒظ†ع© ط³ط§غŒطھ\n\nط¯ظ‚طھ ع©ظ†غŒط¯ ط§ع¯ط± ع¯ط°غŒظ†ظ‡ ط§ط®ط±غŒ strict ط±ظˆط´ظ† ط¨ط§ط´ط¯ ع©ط§ط±ط¨ط± ط§ط² ع¯ط±ظˆظ‡ ع©غŒع© ظ…غŒط´ظˆط¯ ظˆ ظ¾غŒط؛ط§ظ… ظ¾ط§ع© ظ…غŒط´ظ‡ ط¯ط± ط؛غŒط± ط§غŒظ† طµظˆط±طھ ظپظ‚ط· ظ¾غŒط؛ط§ظ… ظ¾ط§ع© ظ…غŒط´ظˆط¯\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#unlock [links|flood|spam|Arabic|member|rtl|sticker|contacts|TgService|strict|forward|badword|emoji|english]\nط¨ط§ط² ع©ط±ط¯ظ† ظ‚ظپظ„ ط§ظ…ع©ط§ظ†ط§طھ ط¨ط§ظ„ط§\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#mute [all|audio|gifs|photo|video|text]\nظ¾ط§ع© ع©ط±ط¯ظ† ط³ط±غŒط¹ ظ‡ظ…ظ‡ ظ¾غŒط؛ط§ظ… ظ‡ط§-ط¹ع©ط³ ظ‡ط§-ع¯غŒظپ ظ‡ط§-طµط¯ط§ ظ‡ط§غŒ ط¶ط¨ط· ط´ط¯ظ‡-ظپغŒظ„ظ…-ظ…طھظ†\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#unmute [all|audio|gifs|photo|video|text]\nط¨ط§ط² ع©ط±ط¯ظ† ظ‚ظپظ„ ط§ظ…ع©ط§ظ†ط§طھ ط¨ط§ظ„ط§\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#setflood [value]\nع¯ط°ط§ط´طھظ† value ط¨ظ‡ ط¹ظ†ظˆط§ظ† ط­ط³ط§ط³غŒطھ ط§ط³ظ¾ظ…\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#settings\nظ†ظ…ط§غŒط´ طھظ†ط¸غŒظ…ط§طھ ع¯ط±ظˆظ‡\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#muteslist\nظ†ظ…ط§غŒط´ ظ†ظˆط¹ ظ¾غŒط؛ط§ظ… ظ‡ط§غŒ ط³ط§غŒظ„ظ†طھ ط´ط¯ظ‡\n*A \"muted\" message type is auto-deleted if posted\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#muteuser [username]\nط³ط§غŒظ„ظ†طھ ع©ط±ط¯ظ† غŒع© ع©ط§ط±ط¨ط± ط®ط§طµ ط¯ط± ع¯ط±ظˆظ‡\nظپظ‚ط· ط®ط±غŒط¯ط§ط± (owner) ظ…غŒطھظˆظ†ظ‡ ع©ط³غŒظˆ ط³ط§غŒظ„ظ†طھ ع©ظ†ظ‡ ظˆظ„غŒ ظ†ط§ط¸ظ… ظ‡ط§ (Mods) ظ…غŒطھظˆظ†ظ†ط¯ ظپط±ط¯ ط±ط§ ط§ط² ط³ط§غŒظ„ظ†طھغŒ ط¯ط± ط¨غŒط§ظˆط±ظ†ط¯\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#mutelist\nظ†ظ…ط§غŒط´ ظ„غŒط³طھ ط§ظپط±ط§ط¯ ط³ط§غŒظ„ظ†طھ ط´ط¯ظ‡\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#clean [rules|about|modlist|mutelist|bots]\nظ¾ط§ع© ع©ط±ط¯ظ† ظ„غŒط³طھ ظ†ط§ط¸ظ… ظ‡ط§-ط¯ط±ط¨ط§ط±ظ‡-ظ„غŒط³طھ ط³ط§غŒظ„ظ†طھ ط´ط¯ظ‡ ظ‡ط§-ظ‚ظˆط§ظ†غŒظ†-ط¨ط§طھ ظ‡ط§\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#log\nط¨ط±ع¯ط±ط¯ط§ظ†ط¯ظ† طھط§ط±غŒط®ع†ظ‡ ع¯ط±ظˆظ‡ ط¯ط± غŒع© ظپط§غŒظ„ ظ…طھظ†غŒ\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#version\nظ†ظ…ط§غŒط´ ظˆط±عکظ† ظˆ ط§ط¯ظ…غŒظ† ظ‡ط§غŒ ط±ط¨ط§طھ!\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#plist\nط¯ط±غŒط§ظپطھ ظ„غŒط³طھ ظ‚غŒظ…طھ ط¨ط±ط§غŒ ط®ط±غŒط¯ ع¯ط±ظˆظ‡...\nâ‍–â‍–â‍–â‍–â‍–â‍–\n#feedback [text]\nط´ظ…ط§ ظ…غŒطھظˆط§ظ†غŒط¯ ط¨ط§ ط§غŒظ† ط¯ط³طھظˆط± ظ†ط¸ط±ط§طھ ظˆ ظ¾غŒط´ظ†ظ‡ط§ط¯ط§طھ ط®ظˆط¯ ط±ط§ ط¨ط±ط§غŒ ظ…ط§ ط§ط±ط³ط§ظ„ ع©ظ†غŒط¯...\nâ‍–â‍–â‍–â‍–â‍–â‍–\n| Channel : @Red_Ch |\n"
			reply_msg(msg.id, text, ok_cb, false)
		end
