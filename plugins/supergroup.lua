SuperGroup settings--Begin supergrpup.lua
...
function show_supergroup_settingsmod(msg, target)
  ...
  local text = "⚙SuperGroup settings⚙:\n\n#Lock Links ▶️ "..settings.lock_link.."\n#Lock Webpage ▶️ "..settings.lock_webpage.."\n#Lock Tag ▶️ "..settings.lock_tag.."\n#Lock Emoji ▶️ "..settings.lock_emoji.."\n#Lock English ▶️ "..settings.lock_eng.."\n#Lock Badword ▶️ "..settings.lock_badw.."\n#Lock Flood ▶️ "..settings.flood.."\n#Flood sensitivity ▶️ "..NUM_MSG_MAX.."\n#Lock Spam ▶️ "..settings.lock_spam.."\n#Lock Contacts ▶️ "..settings.lock_contacts.."\n#Lock Arabic/Persian ▶️ "..settings.lock_arabic.."\n#Lock Member ▶️ "..settings.lock_member.."\n#Lock RTL ▶️ "..settings.lock_rtl.."\n#Lock Forward ▶️ "..settings.lock_fwd.."\n#Lock TGservice ▶️ "..settings.lock_tgservice.."\n#Lock Sticker ▶️ "..settings.lock_sticker.."\n#Public ▶️ "..settings.public.."\n#Strict Settings ▶️ "..settings.strict
